...
class BlogPostTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.post1 = Post.objects.create(
            title='Post1',
            text='This is a description of post 1',
            status=Post.STATUS_CHOICES[0][0],
            author=cls.user,
        )
        cls.post2 = Post.objects.create(
            title='Post2',
            text='This is a description of post 2',
    ...
    def test_post_detail(self):
        ...
        self.assertEqual(self.post1.text, 'This is a description of post 1')
    ...
    def test_post_ditail_on_blog_list_page(self):
    ...
    def test_draft_post_not_show_in_posts_list(self):
        response = self.client.get(reverse('post_list'))  # TDD Test Driven Development
        self.assertContains(response, self.post1.title)
